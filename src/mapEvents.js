...
export const MapEventConfig = {
  ...
  [MapEventType.RAIN]: {
    ...
    triggerCondition: 'halfway',
    triggerValue: 0.5,
    message: '🌧️🌧️🌧️ 먹구름이 몰려옵니다! 폭우로 인해 속도가 느려집니다!!!',
    cameraDuration: 180, // 3초
    duration: 1800, // 30초 동안 지속 (60fps 기준)
    speedMultiplier: 0.5, // 속도 50% 감소
    lightningInterval: 600, // 10초마다 번개 (60fps 기준)
    lightningCount: 3, // 총 3번 번개
  },
};
